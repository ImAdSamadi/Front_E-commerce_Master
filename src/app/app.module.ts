...
import { SidebarComponent } from './components/searched-products-list/sidebar/sidebar.component';
...
@NgModule({
  ...
  imports: [
    ...
    AppRoutingModule,
    StoreModule.forRoot({
      productState: productReducer, selectedProductsState: SelectedProductsReducer
